// RUN: %driver -cc1 %isys -regcall4 -std=c++11 %s %target -o %t%output-suffix && %filecheck
// RUN: %driver -cc1 %isys -regcall4 -std=c++11 %s -DWIN_TEST %target -o %t%output-suffix && %filecheck
